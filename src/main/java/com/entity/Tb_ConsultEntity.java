...
public class Tb_ConsultEntity {
    ...
    public Tb_ConsultEntity() {
    }

    public Tb_ConsultEntity(Integer userId, String consultTitle, String consultBody, Date consultData) {
        this.userId = userId;
    ...
    public Tb_ConsultEntity(Integer consultId, Integer userId, String consultTitle, String consultBody, Date consultData) {
